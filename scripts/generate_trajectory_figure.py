"""
Generate trajectory profiles figure: Trapezoidal vs S-Curve (7-phase jerk-limited).
...
fig.suptitle("Motion Profiles: Trapezoidal vs S-Curve", fontsize=13, fontweight='bold', y=0.98)
...
trap_phase_labels  = ['Accel', 'Cruise', 'Decel']
scurve_phase_labels = ['Jerk↑', 'Const\nAccel', 'Jerk↓', 'Cruise',
                       'Jerk↓', 'Const\nDecel', 'Jerk↑']

# Row data: (data_y, ylabel, title_suffix)
rows = [
    (pos_trap,  pos_scurve,  r'$\theta(t)$ [deg]',            r'Position $\theta(t)$'),
    (vel_trap,  vel_scurve,  r'$\dot\theta$ [°/s]',           r'Velocity $\dot\theta(t)$'),
    (acc_trap,  acc_scurve,  r'$\ddot\theta$ [°/s²]',         r'Acceleration $\ddot\theta(t)$'),
]

col_titles = ['Trapezoidal Profile', 'S-Curve Profile (7-Phase Jerk-Limited)']
